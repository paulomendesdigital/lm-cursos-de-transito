 ...
 */
	public function children(Model $Model, $id = null, $direct = false, $fields = null, $order = null, $limit = null, $page = 1, $recursive = null, $findType='all') {
		if (is_array($id)) {
			extract(array_merge(array('id' => null), $id));
		}
		...
		if ($direct) {
			...
			return $Model->find($findType, compact('conditions', 'fields', 'order', 'limit', 'page', 'recursive'));
		}
