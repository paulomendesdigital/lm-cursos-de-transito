...
<div>
	...
	<?php
	echo $this->Html->link($this->Html->image('/acl/img/design/cross.png') . ' ' . __d('acl', 'Clear permissions table'), '/manager/acl/aros/empty_permissions', array('confirm' => __d('acl', 'Are you sure you want to delete all roles and users permissions ?'), 'escape' => false));
	?>
    	        ...
    	        foreach($plugin_methods as $method)
    	        {
        	        ...
        	        foreach($roles as $role)
    		    	{
    		    	    ...
    		    	    if(isset($ctrl_info['permissions'][$role[$role_model_name][$role_pk_name]]))
    		    	    {
        		    		...
        		    		{
        		    			//echo '<td>' . $this->Html->link($this->Html->image('/acl/img/design/tick.png'), '/manager/acl/aros/deny_role_permission/' . $role[$role_model_name][$role_pk_name] . '/plugin:' . $plugin_name . '/controller:' . $plugin_ctrler_name . '/action:' . $method['name'], array('escape' => false)) . '</td>';
        		    		...
        		    		{
        		    			//echo '<td>' . $this->Html->link($this->Html->image('/acl/img/design/cross.png'), '/manager/acl/aros/grant_role_permission/' . $role[$role_model_name][$role_pk_name] . '/plugin:' . $plugin_name .'/controller:' . $plugin_ctrler_name . '/action:' . $method['name'], array('escape' => false)) . '</td>';
