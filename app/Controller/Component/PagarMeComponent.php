...
class PagarMeComponent extends Component {
    ...
    protected function init(){
        App::import('Vendor', 'pagarme-php/lib/PagarMe');
        die(debug('a'));
        $this->PagarMe = new PagarMe();        
        $this->PagarMe->setApiKey(Configure::read('Pagarme.apikey'));      
    }

    public function createTransaction(){        
        $transaction = new TransactionHandler(array(
        'amount' => 1000,
        'payment_method' => 'boleto',
        'postback_url' => 'https://requestb.in/17r3w9r1',
        'customer' => array(
            'type' => 'individual',
            'country' => 'br',
            'name' => 'Aardvark Silva',
