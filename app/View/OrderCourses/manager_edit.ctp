...
<?php echo $this->Form->create('OrderCourse', array('class' => 'form-horizontal', 'role' => 'form', 'type' => 'file')); ?>
...
<div class="block">
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
		 ...
		 echo $this->Form->input('order_id', array('class' => 'form-control', 'data-mask' => 'order_id', 'label'=>__('order_id')));
		 echo $this->Form->input('course_id', array('class' => 'form-control', 'data-mask' => 'course_id', 'label'=>__('course_id')));
		 echo $this->Form->input('citie_id', array('class' => 'form-control', 'data-mask' => 'citie_id', 'label'=>__('citie_id')));
		 echo $this->Form->input('state_id', array('class' => 'form-control', 'data-mask' => 'state_id', 'label'=>__('state_id')));
	?>
            </div>
        </div>
    </div>
