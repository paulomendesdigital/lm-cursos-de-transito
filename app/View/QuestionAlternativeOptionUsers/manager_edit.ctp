...
<?php echo $this->Form->create('QuestionAlternativeOptionUser', array('class' => 'form-horizontal', 'role' => 'form', 'type' => 'file')); ?>
...
<div class="block">
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
		 ...
		 echo $this->Form->input('question_alternative_option_id', array('class' => 'form-control', 'data-mask' => 'question_alternative_option_id', 'label'=>__('question_alternative_option_id')));
