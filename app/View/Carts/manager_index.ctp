...
<div class="table-responsive">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($cart['Course']['name'], array('controller' => 'courses', 'action' => 'view', $cart['Course']['id'])); ?>
		</td>
		<td><?php echo $this->Utility->__FormatDate($cart['Cart']['created']); ?></td>
		<td><?php echo $this->Utility->__FormatDate($cart['Cart']['modified']); ?></td>
		<td class="actions">
				<?php echo $this->Html->link(__('<span class="icon-eye"></span>'), array('action' => 'view', $cart['Cart']['id']), array('class' => 'btn btn-info btn-xs', 'escape' => false)); ?>
			<?php echo $this->Html->link(__('<span class="icon-pencil"></span>'), array('action' => 'edit', $cart['Cart']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false)); ?>
			<?php echo $this->Form->postLink(__('<span class="icon-remove3"></span>'), array('action' => 'delete', $cart['Cart']['id']), array('class' => 'btn btn-danger btn-xs', 'escape' => false), __('Are you sure you want to delete # %s?', $cart['Cart']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
        </tbody>
