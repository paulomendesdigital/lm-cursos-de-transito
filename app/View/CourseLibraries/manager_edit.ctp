...
<div class="page-header">
    <div class="page-title">
        <h3>Biblioteca Virtual<small><?php echo $this->request->data['Course']['name'];?></small></h3>
    </div>
</div>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
            ...
            <div class="tab-pane fade in" id="image">
                ...
                if( !empty($this->request->data['CourseLibrary']['image']) ){
                    echo $this->Html->image( "/files/course_library/image/{$this->request->data['CourseLibrary']['id']}/vga_{$this->request->data['CourseLibrary']['image']}",['class'=>'img-responsive']);
                }
                ?>
            </div>
        </div>
