...
<div class="panel">
	...
	<ul class="list-group">
		<li class='list-group-item'>
						...
						<div class='col-md-10'><?php echo $moduleDisciplineSlider['ModuleDisciplineSlider']['id']; ?></div>
						</div>
					</li><li class='list-group-item'>
								<div class='row'>
								<div class='col-md-2 text-right'><strong><?php echo __('Module Discipline'); ?></strong></div> 
								<div class='col-md-10'><?php echo $this->Html->link($moduleDisciplineSlider['ModuleDiscipline']['name'], array('controller' => 'module_disciplines', 'action' => 'view', $moduleDisciplineSlider['ModuleDiscipline']['id'])); ?></div>
								</div>
							</li><li class='list-group-item'>
						<div class='row'>
						<div class='col-md-2 text-right'><strong><?php echo __('name'); ?></strong></div> 
						<div class='col-md-10'><?php echo $moduleDisciplineSlider['ModuleDisciplineSlider']['name']; ?></div>
						</div>
					</li><li class='list-group-item'>
						<div class='row'>
						<div class='col-md-2 text-right'><strong><?php echo __('text'); ?></strong></div> 
						<div class='col-md-10'><?php echo $moduleDisciplineSlider['ModuleDisciplineSlider']['text']; ?></div>
						</div>
					</li><li class='list-group-item'>
						<div class='row'>
						<div class='col-md-2 text-right'><strong><?php echo __('audio'); ?></strong></div> 
						<div class='col-md-10'><?php echo $moduleDisciplineSlider['ModuleDisciplineSlider']['audio']; ?></div>
						</div>
					</li><li class='list-group-item'>
						<div class='row'>
						<div class='col-md-2 text-right'><strong><?php echo __('status'); ?></strong></div> 
						<div class='col-md-10'><?php echo $this->Utility->__FormatStatus($moduleDisciplineSlider['ModuleDisciplineSlider']['status']); ?></div>
						</div>
					</li><li class='list-group-item'>
						<div class='row'>
						<div class='col-md-2 text-right'><strong><?php echo __('position'); ?></strong></div> 
						<div class='col-md-10'><?php echo $moduleDisciplineSlider['ModuleDisciplineSlider']['position']; ?></div>
						</div>
					</li><li class='list-group-item'>
						<div class='row'>
						<div class='col-md-2 text-right'><strong><?php echo __('created'); ?></strong></div> 
						<div class='col-md-10'><?php echo $this->Utility->__FormatDate($moduleDisciplineSlider['ModuleDisciplineSlider']['created']); ?></div>
						</div>
					</li><li class='list-group-item'>
						<div class='row'>
						<div class='col-md-2 text-right'><strong><?php echo __('modified'); ?></strong></div> 
						<div class='col-md-10'><?php echo $this->Utility->__FormatDate($moduleDisciplineSlider['ModuleDisciplineSlider']['modified']); ?></div>
						</div>
					</li>	</ul>
</div>
...
<div class="panel">
	...
	<?php if (!empty($moduleDisciplineSlider['UserModuleLog'])): ?>
	...
	<thead>
		...
		<th><?php echo __('Modified'); ?></th>
			...
			<tbody>
	<?php foreach ($moduleDisciplineSlider['UserModuleLog'] as $userModuleLog): ?>
		<tr>
