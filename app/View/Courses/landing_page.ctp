...
<div id="header">
    <div class="navbar">
        <div class="container">
                <?php echo $this->Html->image('site/logo-focus-color.png',['alt'=>'Focus Concursos','title'=>'Focus Concursos']); ?>
                <?php echo $this->Html->image('site/logo-header.png',['alt'=>'LM Cursos de Trânsito','title'=>'LM Cursos de Trânsito', 'style'=>'float:right; max-height:81px;']); ?>
        </div>
    </div>
</div>
