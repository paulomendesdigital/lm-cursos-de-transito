...
<div class="block">
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
		 ...
		 echo $this->Form->input('desblock', array('class' => 'form-control', 'data-mask' => 'desblock', 'label'=>__('Bloqueio'),'after'=> '<small class="text-muted">0 para bloquear e 1 para desbloquear</small>'));
	?>
            </div>
        </div>
    </div>
