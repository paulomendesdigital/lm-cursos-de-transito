...
<div class="page-header">
    <div class="page-title">
        <h3>Multimidia Virtual<small><?php echo $this->request->data['Course']['name'];?></small></h3>
    </div>
</div>
...
<br>
<br>
<?php echo $this->Form->create('CourseMultimidia', array('class' => 'form-horizontal', 'role' => 'form', 'type' => 'file')); ?>
        ...
        <div class="tab-content with-padding">
            <div class="tab-pane fade in active" id="details">
    			<?php
					...
					//echo $this->Form->input('filename',  ['class'=>'form-control', 'type'=>'file','label'=>__('Arquivo'), 'after'=>!empty($this->request->data['CourseMultimidia']['filename'])?'<small class="text-success"> arquivo enviado!</small>':'<small class="text-warning"> arquivo não enviado até o momento!</small>']);
            ...
            <div class="tab-pane fade in" id="image">
                ...
                if( !empty($this->request->data['CourseMultimidia']['image']) ){
                    echo $this->Html->image( "/files/course_multimidia/image/{$this->request->data['CourseMultimidia']['id']}/vga_{$this->request->data['CourseMultimidia']['image']}",['class'=>'img-responsive']);
                }
                ?>
            </div>
        </div>
