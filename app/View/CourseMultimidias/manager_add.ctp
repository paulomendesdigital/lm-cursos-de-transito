...
<div class="page-header">
    <div class="page-title">
        <h3>Multimidias <small><?php echo $courses[$course_id];?></small></h3>
    </div>
</div>
        ...
        <div class="tabbable">
            ...
            <div class="tab-content with-padding">
                ...
                <div class="tab-pane fade in" id="image">
                    <?php echo $this->Form->input('image', ['class'=>'form-control', 'label'=>__('Imagem').'<small> (400x400)</small>','type'=>'file']);?>
                </div>
            </div>
        </div>
    </div><!-- /block-->
