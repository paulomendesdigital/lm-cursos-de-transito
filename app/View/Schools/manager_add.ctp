...
<div class="page-header">
    <div class="page-title">
        <h3>Auto Escola <small>Adicionar novo</small></h3>
    </div>
</div>
            ...
            <div class="tab-pane fade in active" id="details">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php echo $this->Form->input('image', array('type' => 'file','class' => 'form-control', 'label'=>__('Imagem')));?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php echo $this->Form->input('phone',['class'=>'form-control','label'=>'Telefone','data-mask'=>'cellphone','required'=>false]); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
