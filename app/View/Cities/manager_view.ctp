...
<div class="panel">
	...
	<ul class="list-group">
		<li class='list-group-item'>
						...
						<div class='col-md-10'><?php echo $city['City']['id']; ?></div>
						</div>
					</li><li class='list-group-item'>
								<div class='row'>
								<div class='col-md-2 text-right'><strong><?php echo __('State'); ?></strong></div> 
								<div class='col-md-10'><?php echo $this->Html->link($city['State']['name'], array('controller' => 'states', 'action' => 'view', $city['State']['id'])); ?></div>
								</div>
							</li><li class='list-group-item'>
						<div class='row'>
						<div class='col-md-2 text-right'><strong><?php echo __('name'); ?></strong></div> 
						<div class='col-md-10'><?php echo $city['City']['name']; ?></div>
						</div>
					</li>	</ul>
</div>
