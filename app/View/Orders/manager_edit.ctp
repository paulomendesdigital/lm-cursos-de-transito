    ...
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
            ...
            <div class="tab-pane" id="options">
                <div class="row">
                    <div class="col-md-5"><h6>Curso</h6></div>
                        ...
                        <div data-toggle="course<?php echo $key;?>">
                            <div data-toggle="formCourse<?php echo $key;?>">
                                <div class="row">
                                    ...
                                    <div class="col-md-3"><?php echo $this->Form->input('OrderCourse.'.$key.'.citie_id', array('class' => 'form-control', 'data-mask' => 'module_id', 'label'=>false, 'div' => false, 'options' => isset($OrderCourse['Citie']['id']) ? [$OrderCourse['Citie']['id'] => $OrderCourse['Citie']['name']]  : [] )); ?></div>
