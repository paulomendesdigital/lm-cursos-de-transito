...
<?php echo $this->Form->create('ForumPostComment', array('class' => 'form-horizontal', 'role' => 'form', 'type' => 'file')); ?>
    ...
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
            <div class="tab-pane fade in active" id="details">
                	<?php
		 echo $this->Form->input('forum_post_id', array('class' => 'form-control', 'data-mask' => 'forum_post_id', 'label'=>__('forum_post_id')));
		 ...
		 echo $this->Form->input('text', array('class' => 'form-control ckeditor', 'id'=>'ckfinder', 'label'=>__('text')));
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-sm-10'>
                                        ...
                                        <a class='btn <?php echo isset($this->request->data['ForumPostComment']['status']) ? $this->request->data['ForumPostComment']['status'] == 0 ? 'btn-danger' : '' : 'btn-danger'; ?> btn-sm' data-id='0' data-toggle='btnStatus'>Inativo</a>
<?php echo $this->Form->input('status', array('type' => 'hidden', 'data-toggle' => 'afferStatus'));?>
<a class='btn <?php echo isset($this->request->data['ForumPostComment']['status']) ? $this->request->data['ForumPostComment']['status'] == 1 ? 'btn-success' : '' : ''; ?> btn-sm' data-id='1' data-toggle='btnStatus'>Ativo</a>
