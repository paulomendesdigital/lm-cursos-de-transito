<?php if( $course['Course']['avaliation']['show_certificate'] ):?>
  <div class="text-center bg-transparent margin-none">
    ...
    <p >
    	<a href="<?php echo Router::url('/', true).'virtual_rooms/certificate/'.$this->params['pass'][0].'.pdf';?>" target="_blank" class="btn btn-success btn-lg btn-finish-course text-center hidden-xs"><i class="fa fa-fw fa-check"></i> Clique aqui para finalizar o curso</a>
    	<a href="<?php echo Router::url('/', true).'virtual_rooms/certificate/'.$this->params['pass'][0].'.pdf';?>" target="_blank" class="btn btn-success btn-lg btn-finish-course text-center visible-xs"><i class="fa fa-fw fa-check"></i> Finalizar Curso</a>
    </p>
    <p>
