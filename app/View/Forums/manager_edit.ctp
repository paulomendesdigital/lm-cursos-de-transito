    ...
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
            <div class="tab-pane fade in active" id="details">
		        ...
		        echo $this->Form->input('state_id', array('class' => 'form-control', 'data-mask' => 'state_id', 'label'=>__('state_id'), 'data-toggle'=>'returnState'));
                echo $this->Form->input('citie_id', array('class' => 'form-control', 'data-mask' => 'citie_id', 'label'=>__('citie_id'), 'empty' => 'Selecione o estado', 'data-toggle'=>'returnCity', 'options' => [$this->request->data['Citie']['id'] => $this->request->data['Citie']['name']]));
