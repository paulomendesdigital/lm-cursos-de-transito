...
<div class="table-responsive">
	...
	<tr>
		...
		<td><?php echo $this->Utility->__LimitText($orderType['OrderType']['name']); ?></td>
		<td><?php echo $this->Utility->__FormatDate($orderType['OrderType']['created']); ?></td>
		<td><?php echo $this->Utility->__FormatDate($orderType['OrderType']['modified']); ?></td>
		<td class="actions">
				<?php echo $this->Html->link(__('<span class="icon-eye"></span>'), array('action' => 'view', $orderType['OrderType']['id']), array('class' => 'btn btn-info btn-xs', 'escape' => false)); ?>
			<?php echo $this->Html->link(__('<span class="icon-pencil"></span>'), array('action' => 'edit', $orderType['OrderType']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false)); ?>
			<?php echo $this->Form->postLink(__('<span class="icon-remove3"></span>'), array('action' => 'delete', $orderType['OrderType']['id']), array('class' => 'btn btn-danger btn-xs', 'escape' => false), __('Are you sure you want to delete # %s?', $orderType['OrderType']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
        </tbody>
