    ...
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
            <div class="tab-pane fade in active" id="details">
                ...
                echo $this->Form->input('Student.0.school_id', array('type' => 'text', 'class' => 'form-control auto-select2', 'label' => __('Auto Escola'), 'required' => false, 'data-url' => '/manager/users/ajaxSelect2Schools', 'placeholder' => 'Selecione'));
            ...
            <div class="tab-pane fade" id="address">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php echo $this->Form->hidden('Student.0.status',['value'=>1]); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-xs-12 col-sm-12">
                        <?php echo $this->Form->input('Student.0.state_id',['class'=>'form-control','label'=>'Estado', 'data-toggle'=>'returnState']); ?>
                    </div>
                    <div class="col-md-3 col-xs-12 col-sm-12">
