...
<div class="block">
    <div class="tabbable">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#curriculum" data-toggle="tab"><i class="icon-file"></i> Currículo</a></li>
        </ul>
            ...
            <div class="tab-pane fade" id="address">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php echo $this->Form->hidden('Instructor.0.status',['value'=>1]); ?>
                        <?php echo $this->Form->input('Instructor.0.zipcode',['class'=>'form-control','label'=>'CEP','data-mask'=>'zipcode','required'=>true]); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php echo $this->Form->input('Instructor.0.address',['class'=>'form-control','label'=>'Endereço','required'=>true, 'data-toggle'=>'returnAddress']); ?>
                    </div>
                    <div class="col-md-2 col-sm-12 col-xs-12">
                        <?php echo $this->Form->input('Instructor.0.number',['class'=>'form-control','label'=>'Nº','required'=>true, 'data-toggle'=>'returnNumber']); ?>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <?php echo $this->Form->input('Instructor.0.complement',['class'=>'form-control','label'=>'Compl.','required'=>true]); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-xs-12 col-sm-12">
                        <?php echo $this->Form->input('Instructor.0.neighborhood',['class'=>'form-control','label'=>'Bairro','required'=>true, 'data-toggle'=>'returnNeighborhood']); ?>
                    </div>
                    <div class="col-md-3 col-xs-12 col-sm-12">
                        <?php echo $this->Form->input('Instructor.0.state_id',['class'=>'form-control','label'=>'Estado','required'=>true, 'data-toggle'=>'returnState']); ?>
                    </div>
                    <div class="col-md-3 col-xs-12 col-sm-12">
                        <?php echo $this->Form->input('Instructor.0.city_id',['class'=>'form-control','label'=>'Cidade','required'=>true, 'data-toggle'=>'returnCity']); ?>
                    </div>
                </div>
            </div>
            <div class="tab-pane fade in" id="curriculum">
                <?php echo $this->Form->input('Instructor.0.text', array('class'=>'form-control ckeditor', 'id'=>'ckfinder','label'=>__('Currículo')));?>
            </div>
        </div>
    </div>
</div><!-- /block-->
