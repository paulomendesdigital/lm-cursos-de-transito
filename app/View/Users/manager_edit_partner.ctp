    ...
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
            <div class="tab-pane fade in active" id="details">
                ...
                echo $this->Form->hidden('Partner.0.id');
            ...
            <div class="tab-pane fade" id="address">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php echo $this->Form->hidden('Partner.0.id'); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-xs-12 col-sm-12">
                        <?php echo $this->Form->input('Partner.0.state_id',['class'=>'form-control','label'=>'Estado', 'data-toggle'=>'returnOneState']); ?>
                    </div>
                    <div class="col-md-3 col-xs-12 col-sm-12">
            ...
            <div class="tab-pane fade in" id="curriculum">
                <?php echo $this->Form->input('Partner.0.text', array('class'=>'form-control ckeditor', 'id'=>'ckfinder','label'=>__('Observações sobre o aluno')));?>
            </div>
