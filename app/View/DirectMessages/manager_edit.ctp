...
<?php echo $this->Form->create('DirectMessage', array('class' => 'form-horizontal', 'role' => 'form', 'type' => 'file')); ?>
...
<div class="block">
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
		 ...
		 echo $this->Form->input('view_user', array('class' => 'form-control', 'data-mask' => 'view_user', 'label'=>__('view_user')));
		 echo $this->Form->input('view_instructor', array('class' => 'form-control', 'data-mask' => 'view_instructor', 'label'=>__('view_instructor')));
