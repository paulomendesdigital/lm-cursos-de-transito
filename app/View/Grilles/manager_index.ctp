...
<div class="table-responsive">
	...
	<tr>
		<td><?php echo h($grille['Grille']['id']); ?></td>
		<td><?php echo $this->Utility->__LimitText($grille['Grille']['name']); ?></td>
		<td><?php echo $this->Utility->__FormatStatus($grille['Grille']['status']); ?></td>
		<td><?php echo $this->Utility->__FormatDate($grille['Grille']['created']); ?></td>
		<td><?php echo $this->Utility->__FormatDate($grille['Grille']['modified']); ?></td>
		<td class="actions">
				<?php echo $this->Html->link(__('<span class="icon-eye"></span>'), array('action' => 'view', $grille['Grille']['id']), array('class' => 'btn btn-info btn-xs', 'escape' => false)); ?>
			<?php echo $this->Html->link(__('<span class="icon-pencil"></span>'), array('action' => 'edit', $grille['Grille']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false)); ?>
			<?php echo $this->Form->postLink(__('<span class="icon-remove3"></span>'), array('action' => 'delete', $grille['Grille']['id']), array('class' => 'btn btn-danger btn-xs', 'escape' => false), __('Are you sure you want to delete # %s?', $grille['Grille']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
        </tbody>
