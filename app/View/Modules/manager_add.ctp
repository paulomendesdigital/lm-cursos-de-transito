    ...
    <div class="tabbable">
        ...
        <div class="tab-content with-padding">
            <div class="tab-pane fade in active" id="details">
                ...
                echo $this->Form->input('is_introduction', array('type' => 'checkbox','class' => 'switch', 'data-on' => 'success', 'data-off' => 'danger', 'data-on-label' => 'Sim', 'data-off-label' => 'Não','data-mask' => 'is_introduction', 'label'=> __('Introdução?')));
