...
$limite_time = $course['Course']['max_time_course_avaliation'];
?>
...
<div class="page-section half bg-white fixed-bar-simulated">
    <div class="container">
        <div class="section-toolbar">
                ...
                <div class="cell">
                    <div class="media width-100 v-middle margin-none">
                        ...
                        <div class="media-body">
                            ...
                            <p class="text-title text-primary margin-none qt_questions"><?php echo $qt_questions;?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="cell">
                    <div class="media width-110 v-middle margin-none">
                        ...
                        <div class="media-body">
                            ...
                            <p class="text-title text-primary margin-none"><?php echo number_format($course['Course']['value_course_avaliation'], 0);?>%</p>
                        </div>
                    <?php endif; ?>
                    </div>
                </div>
            ...
            <?php if($course['Course']['max_time_course_avaliation']): ?>
            ...
            <div class="page-section height-100pc">
                <div class="row height-100pc">
                    ...
                    <p class="text-light text-caption">
                        ...
                        <i class="fa fa-fw  fa-angle-right"></i> Avaliação do curso
                      </p>

                    <div class="page-section padding-top-none">
		                <div class="media v-middle">
		                    <div class="media-body">
		                        <h1 class="text-display-1 margin-none"> Avaliação de curso
		                        <small> - <?php echo $course['Course']['name'];?></small></h1>
	                            ...
	                            <div class="panel-body">
	                                ...
	                                <?php foreach ($question_alternative['QuestionAlternativeOption'] as $question_alternative_option):?>
	                                	<div class="radio radio-primary">
	                                        <input data-id="data_<?php echo $key;?>_QuestionAlternativeOptionUser_question_alternative_option_id" type="radio" name="data[<?php echo $key;?>][QuestionAlternativeOptionUser][question_alternative_option_id]" id="radio<?php echo $key;?><?php echo $question_alternative_option['id'];?>" value="<?php echo $question_alternative_option['id'];?>">
...
<script type="text/javascript">
    var count = <?php echo $course['Course']['max_time_course_avaliation'];?>;
