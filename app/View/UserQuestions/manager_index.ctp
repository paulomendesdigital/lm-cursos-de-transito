...
<div class="table-responsive">
	...
	<tr>
		<td><?php echo h($userQuestion['UserQuestion']['id']); ?></td>
		<td>
			<?php echo $this->Html->link($userQuestion['User']['name'], array('controller' => 'users', 'action' => 'view', $userQuestion['User']['id'])); ?>
		</td>
		<td><?php echo $this->Utility->__FormatDate($userQuestion['UserQuestion']['created']); ?></td>
		<td><?php echo $this->Utility->__FormatDate($userQuestion['UserQuestion']['modified']); ?></td>
		<td class="actions">
				<?php echo $this->Html->link(__('<span class="icon-eye"></span>'), array('action' => 'view', $userQuestion['UserQuestion']['id']), array('class' => 'btn btn-info btn-xs', 'escape' => false)); ?>
			<?php echo $this->Html->link(__('<span class="icon-pencil"></span>'), array('action' => 'edit', $userQuestion['UserQuestion']['id']), array('class' => 'btn btn-primary btn-xs', 'escape' => false)); ?>
			<?php echo $this->Form->postLink(__('<span class="icon-remove3"></span>'), array('action' => 'delete', $userQuestion['UserQuestion']['id']), array('class' => 'btn btn-danger btn-xs', 'escape' => false), __('Are you sure you want to delete # %s?', $userQuestion['UserQuestion']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
        </tbody>
